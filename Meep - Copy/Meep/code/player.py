...
class Player(Entity):
	def __init__(self,position,groups,obstacle_sprites,create_attack,destroy_attack,create_magic):
		...
		self.hitbox = self.rect.inflate(-6,boombox['player'])
		...
		# stats
		self.stats = {'health': 200,'energy':100,'attack': 20,'magic': 10,'speed': 5}
		self.max_stats = {'health': 500, 'energy': 200, 'attack': 50, 'magic' : 40, 'speed': 15}
